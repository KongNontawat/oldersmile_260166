        ...
        <div class="row gy-3 mt-2 mt-lg-3">
            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-body">
                        <h5 class="mb-3">ข่าวประชาสัมพันธ์</h5>
                        <?php foreach($query_act as $act): ?>
                        <div class="d-flex pb-2 mb-2 border-bottom">
                            <div class="flex-shrink-1">
                                <img src="img/<?php echo $act['post_media'] ?>" alt="" class="rounded-4" width="150" height="100">
                            </div>
                            <div class="flex-grow-0 ms-2">
                                <a href="user_profile.php?id=<?php echo $act['user_id'] ?>" class="d-flex align-items-center">
                                    <img src="img/<?php echo $act['user_image'] ?>" alt="" class="rounded-circle me-2" width="30" height="30">
                                    <p><?php echo $act['user_name'] ?></p>
                                    <?php if($act['user_role'] == 'admin' OR $act['user_role'] == 'partner') : ?>
                                    <img src="icon/verify.png" alt="" class="ms-1" width="15" height="15">
                                    <?php endif; ?>
                                </a>
                                <small class="text-muted"><?php echo $act['post_created'] ?></small>
                                <p class="text-o-1"><?php echo $act['post_body'] ?></p>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
