            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-body text-center ">
                        <h4 class="my-3">โปรไฟล์ของฉัน</h4>
                        <img src="img/<?php echo $row['user_image'] ?>" alt="" class="rounded-circle my-3" width="140" height="140">
                        <h3 class="mb-3"><?php echo $row['user_name'] ?></h3>
                        <small class="text-muted mb-3">(รหัสสมาชิก : <?php echo $row['user_id'] ?>)</small>
                        ...
                        <div class="my-3 d-flex justify-content-center align-items-center">
                            ...
                            <h5>จำนวนเงินในกระเป๋า : <?php echo number_format( $row['user_wallet'],2) ?> บาท</h5>
                        </div>

                        <?php if($row['user_role'] == 'user'): ?>
                        <a href="part.php" class="mt-3 text-success fs-5">สมัครเป็นพาร์ทเนอร์กับเรา?</a> <br>
                        <a href="mar.php" class="mt-3 text-warning fs-5">สมัครเป็นร้านค้ากับเรา?</a>
                        <?php endif; ?>

                        <a href="edit_profile.php" class="btn btn-outline-primary mt-3 col-12">แก้ไขโปรไฟล์</a>
                        <?php if($row['user_role'] == 'admin'): ?>
                        <a href="admin/user_mng.php" class="btn btn-outline-secondary mt-2 col-12">จัดการหลังบ้าน</a>
                        <?php endif; ?>

                        <p class="mt-3 text-start">ขนาดตัวอักษร</p>
                        <ul class="nav nav-pills nav-fill mt-2">
                            <li class="nav-item"><a href="set_proc/setting.php?font=16" class="nav-link border <?php echo ($set == '16')? ' active text-white':'';?>" style="font-size: 16px;">A+</a></li>
                            <li class="nav-item"><a href="set_proc/setting.php?font=18" class="nav-link border <?php echo ($set == '18')? ' active text-white':'';?>" style="font-size: 18px;">A+</a></li>
                            <li class="nav-item"><a href="set_proc/setting.php?font=20" class="nav-link border <?php echo ($set == '20')? ' active text-white':'';?>" style="font-size: 20px;">A+</a></li>
                            <li class="nav-item"><a href="set_proc/setting.php?font=22" class="nav-link border <?php echo ($set == '22')? ' active text-white':'';?>" style="font-size: 22px;">A+</a></li>
                        </ul>

                        <a href="auth_proc/logout.php" class="mt-4 d-block text-danger">ออกจากระบบ?</a>
