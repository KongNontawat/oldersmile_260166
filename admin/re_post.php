...
$sql = "SELECT *, COUNT(c.com_id) AS count FROM post AS p LEFT JOIN comment AS c ON p.post_id = c.post_id GROUP BY p.post_id";
...
<body>
                ...
                <div class="container-fluid mt-3 pb-5">
                    ...
                    <div class="p-4 rounded-4 shadow-sm bg-white">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">รายงานแบบประเมิน</li>
                        </ol>
                            ...
                            <table class="table table-hover align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%;">โพสต์เมื่อ</th>
                                        <th style="width: 25%;">จำนวนรายการถามตอบกระทู้</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i+1;?></td>
                                        <td><img src="../img/<?php echo $row['post_media'];?>" height="100" alt=""></td>
                                        <td><?php echo $row['post_body'];?></td>
                                        <td><?php echo $row['post_created'];?></td>
                                        <td><?php echo number_format($row['count']);?> รายการ</td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
                            </table>
    ...
    <script>
        $(function(){
            $('.sidebar a.re_post').addClass('active');
        })
    </script>
