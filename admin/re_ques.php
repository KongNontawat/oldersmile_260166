...
$sql = "SELECT *, AVG(qa.ques_answer) AS answer FROM ques_answer AS qa LEFT JOIN question AS q ON q.ques_id = qa.ques_id GROUP BY qa.ques_id";
...
<body>
                            ...
                            <table class="table table-hover align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 25%;">คะแนนเฉลี่ย</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i+1;?></td>
                                        <td><?php echo $row['ques_body'];?></td>
                                        <td><?php echo number_format($row['answer'],2);?></td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
                            </table>
    ...
    <script>
        $(function(){
            $('.sidebar a.re_ques').addClass('active');
        })
    </script>
